...
/**
 * 현지시각(LT) 표기 — 브라우저 타임존이 아니라 실제 지리적 위치(항구) 기준으로 시각을 표시한다.
 * AI 운항 리포트와 물류 일정 관리 화면이 공유한다(docs/specs/AI_REPORT.md 6.8장,
 * docs/specs/SCHEDULE.md 6.8장). 날짜/숫자는 UI 언어와 무관하게 항상 ko-KR 로케일로 고정한다.
 */
...
/** AI 분석 일시 등 자연어 포맷: "2026년 8월 2일 6시 0분" */
